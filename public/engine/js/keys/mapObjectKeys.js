...
(function (Lich) {
    ...
    (function (MapObjectKey) {
        ...
        MapObjectKey[MapObjectKey["MAP_XMAS_HOLLY_KEY"] = 36] = "MAP_XMAS_HOLLY_KEY";
        MapObjectKey[MapObjectKey["MAP_XMAS_CHAIN_KEY"] = 37] = "MAP_XMAS_CHAIN_KEY";
        MapObjectKey[MapObjectKey["MAP_XMAS_TREE_KEY"] = 38] = "MAP_XMAS_TREE_KEY";
        MapObjectKey[MapObjectKey["MAP_ADVENT_WREATH_KEY"] = 39] = "MAP_ADVENT_WREATH_KEY";
        MapObjectKey[MapObjectKey["MAP_SNOWMAN_KEY"] = 40] = "MAP_SNOWMAN_KEY";
        MapObjectKey[MapObjectKey["MAP_WOOD_CHAIR_KEY"] = 41] = "MAP_WOOD_CHAIR_KEY";
        MapObjectKey[MapObjectKey["MAP_WOOD_CHAIR2_KEY"] = 42] = "MAP_WOOD_CHAIR2_KEY";
        MapObjectKey[MapObjectKey["MAP_WOOD_TABLE_KEY"] = 43] = "MAP_WOOD_TABLE_KEY";
        MapObjectKey[MapObjectKey["MAP_GOLD_COINS_KEY"] = 44] = "MAP_GOLD_COINS_KEY";
        MapObjectKey[MapObjectKey["MAP_GOLD_COINS2_KEY"] = 45] = "MAP_GOLD_COINS2_KEY";
        MapObjectKey[MapObjectKey["MAP_SILVER_COINS_KEY"] = 46] = "MAP_SILVER_COINS_KEY";
        MapObjectKey[MapObjectKey["MAP_GOLD_DISHES_KEY"] = 47] = "MAP_GOLD_DISHES_KEY";
        MapObjectKey[MapObjectKey["MAP_GOLD_DISHES2_KEY"] = 48] = "MAP_GOLD_DISHES2_KEY";
        MapObjectKey[MapObjectKey["MAP_GOLD_BOWL_KEY"] = 49] = "MAP_GOLD_BOWL_KEY";
        MapObjectKey[MapObjectKey["MAP_SKELETON_ON_CHAIR_KEY"] = 50] = "MAP_SKELETON_ON_CHAIR_KEY";
        MapObjectKey[MapObjectKey["MAP_DEAD_FIREPLACE_KEY"] = 51] = "MAP_DEAD_FIREPLACE_KEY";
        MapObjectKey[MapObjectKey["MAP_DEAD_CHANDELIER_KEY"] = 52] = "MAP_DEAD_CHANDELIER_KEY";
        MapObjectKey[MapObjectKey["MAP_WOODEN_CHEST_KEY"] = 53] = "MAP_WOODEN_CHEST_KEY";
        MapObjectKey[MapObjectKey["MAP_WOODEN_GOLD_CHEST_KEY"] = 54] = "MAP_WOODEN_GOLD_CHEST_KEY";
        MapObjectKey[MapObjectKey["MAP_ARMCHAIR_KEY"] = 55] = "MAP_ARMCHAIR_KEY";
        MapObjectKey[MapObjectKey["MAP_BOOKS_KEY"] = 56] = "MAP_BOOKS_KEY";
        MapObjectKey[MapObjectKey["MAP_BOOKSHELF_KEY"] = 57] = "MAP_BOOKSHELF_KEY";
        MapObjectKey[MapObjectKey["MAP_CABINET_KEY"] = 58] = "MAP_CABINET_KEY";
        MapObjectKey[MapObjectKey["MAP_CANDLE_KEY"] = 59] = "MAP_CANDLE_KEY";
        MapObjectKey[MapObjectKey["MAP_PORTRAIT_VALENTIMON_KEY"] = 60] = "MAP_PORTRAIT_VALENTIMON_KEY";

...
(function (Lich) {
    Lich.SURFACE_BGR_DEFS = [
        new Lich.MapSurfaceBgrDefinition(Lich.SurfaceBgrKey.SRFC_BGR_BRICK_KEY, Lich.InventoryKey.INV_BRICK_KEY, 1),
        new Lich.MapSurfaceBgrDefinition(Lich.SurfaceBgrKey.SRFC_BGR_ROCK_BRICK_KEY, Lich.InventoryKey.INV_ROCK_BRICK_KEY, 1),

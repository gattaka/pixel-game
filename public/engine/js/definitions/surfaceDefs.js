...
(function (Lich) {
    Lich.SURFACE_DEFS = [
        ...
        new Lich.MapSurfaceDefinition(Lich.SurfaceKey.SRFC_IRON_PLATFORM_KEY, Lich.InventoryKey.INV_IRON_PLATFORM_KEY, 1, 1, true).setDepth(-1, -1),
        new Lich.MapSurfaceDefinition(Lich.SurfaceKey.SRFC_WOOD_PLATFORM_KEY, Lich.InventoryKey.INV_WOOD_PLATFORM_KEY, 1, 1, true).setDepth(-1, -1)
    ];
})(Lich || (Lich = {}));

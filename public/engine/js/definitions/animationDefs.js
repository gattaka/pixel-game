...
(function (Lich) {
    ...
    Lich.ANIMATION_DEFS = [
        // characters
        new AnimationDefinition(Lich.SpritesheetKey.SPST_OBJECTS_KEY, "lich_animation", Lich.AnimationSetKey.LICH_ANIMATION_KEY, 40, 56, 80)
        ...
        new AnimationDefinition(Lich.SpritesheetKey.SPST_OBJECTS_KEY, "bunny", Lich.AnimationSetKey.BUNNY_ANIMATION_KEY, 13, 32, 32)
        ...
        new AnimationDefinition(Lich.SpritesheetKey.SPST_OBJECTS_KEY, "chicken", Lich.AnimationSetKey.CHICKEN_ANIMATION_KEY, 15, 26, 26)
        ...
        new AnimationDefinition(Lich.SpritesheetKey.SPST_OBJECTS_KEY, "corpse_animation", Lich.AnimationSetKey.CORPSE_ANIMATION_KEY, 30, 56, 80)
            .add(Lich.AnimationKey.ANM_HERO_IDLE_KEY, 0, 0, Lich.AnimationKey.ANM_HERO_BREATH_KEY, 0.005)
            .add(Lich.AnimationKey.ANM_HERO_BREATH_KEY, 1, 1, Lich.AnimationKey.ANM_HERO_IDLE_KEY, 0.04)
            .add(Lich.AnimationKey.ANM_HERO_WALKR_KEY, 2, 9, Lich.AnimationKey.ANM_HERO_WALKR_KEY, 0.3)
            .add(Lich.AnimationKey.ANM_HERO_WALKL_KEY, 10, 17, Lich.AnimationKey.ANM_HERO_WALKL_KEY, 0.3)
            ...
            .add(Lich.AnimationKey.ANM_HERO_DIE_KEY, 28, 28, Lich.AnimationKey.ANM_HERO_DEAD_KEY, 0.2)
            .add(Lich.AnimationKey.ANM_HERO_DEAD_KEY, 29, 29, Lich.AnimationKey.ANM_HERO_DEAD_KEY, 0.2),
        new AnimationDefinition(Lich.SpritesheetKey.SPST_OBJECTS_KEY, "chicken_boss", Lich.AnimationSetKey.CHICKEN_BOSS_ANIMATION_KEY, 2, 184, 304)
        ...
        new AnimationDefinition(Lich.SpritesheetKey.SPST_OBJECTS_KEY, "hellhound", Lich.AnimationSetKey.HELLHOUND_ANIMATION_KEY, 25, 128, 86)
        ...
        new AnimationDefinition(Lich.SpritesheetKey.SPST_OBJECTS_KEY, "cupid", Lich.AnimationSetKey.CUPID_ANIMATION_KEY, 6, 256, 320)
        ...
        new AnimationDefinition(Lich.SpritesheetKey.SPST_OBJECTS_KEY, "valentimon", Lich.AnimationSetKey.VALENTIMON_ANIMATION_KEY, 9, 64, 64)
        ...
        // gfx animations
        new AnimationDefinition(Lich.SpritesheetKey.SPST_OBJECTS_KEY, "blast_animation", Lich.AnimationSetKey.FIREBALL_ANIMATION_KEY, 5, 60, 60)
        ...
        new AnimationDefinition(Lich.SpritesheetKey.SPST_OBJECTS_KEY, "meteor_animation", Lich.AnimationSetKey.METEOR_ANIMATION_KEY, 5, 120, 120)
        ...
        new AnimationDefinition(Lich.SpritesheetKey.SPST_OBJECTS_KEY, "bolt_animation", Lich.AnimationSetKey.ICEBOLT_ANIMATION_KEY, 5, 60, 60)
        ...
        new AnimationDefinition(Lich.SpritesheetKey.SPST_OBJECTS_KEY, "loveletter_animation", Lich.AnimationSetKey.LOVELETTER_ANIMATION_KEY, 6, 32, 32)
        ...
        new AnimationDefinition(Lich.SpritesheetKey.SPST_OBJECTS_KEY, "lovearrow_animation", Lich.AnimationSetKey.LOVEARROW_ANIMATION_KEY, 6, 32, 32)

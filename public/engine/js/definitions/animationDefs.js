...
(function (Lich) {
    ...
    Lich.ANIMATION_DEFS = [
        // characters
        new AnimationSetDefinition(Lich.SpritesheetKey.SPST_MAIN_KEY, "anm_lich", Lich.AnimationSetKey.LICH_ANIMATION_KEY, 40, 56, 80)
        ...
        new AnimationSetDefinition(Lich.SpritesheetKey.SPST_MAIN_KEY, "anm_bunny", Lich.AnimationSetKey.BUNNY_ANIMATION_KEY, 13, 32, 32)
        ...
        new AnimationSetDefinition(Lich.SpritesheetKey.SPST_MAIN_KEY, "anm_chicken", Lich.AnimationSetKey.CHICKEN_ANIMATION_KEY, 15, 26, 26)
        ...
        new AnimationSetDefinition(Lich.SpritesheetKey.SPST_MAIN_KEY, "anm_corpse", Lich.AnimationSetKey.CORPSE_ANIMATION_KEY, 30, 56, 80)
        ...
        new AnimationSetDefinition(Lich.SpritesheetKey.SPST_MAIN_KEY, "anm_chicken_boss", Lich.AnimationSetKey.CHICKEN_BOSS_ANIMATION_KEY, 2, 184, 304)
        ...
        new AnimationSetDefinition(Lich.SpritesheetKey.SPST_MAIN_KEY, "anm_hellhound", Lich.AnimationSetKey.HELLHOUND_ANIMATION_KEY, 25, 128, 86)
        ...
        new AnimationSetDefinition(Lich.SpritesheetKey.SPST_MAIN_KEY, "anm_cupid", Lich.AnimationSetKey.CUPID_ANIMATION_KEY, 6, 256, 320)
        ...
        new AnimationSetDefinition(Lich.SpritesheetKey.SPST_MAIN_KEY, "anm_valentimon", Lich.AnimationSetKey.VALENTIMON_ANIMATION_KEY, 9, 64, 64)
        ...
        // gfx animations
        new AnimationSetDefinition(Lich.SpritesheetKey.SPST_MAIN_KEY, "anm_blast", Lich.AnimationSetKey.FIREBALL_ANIMATION_KEY, 5, 60, 60)
        ...
        new AnimationSetDefinition(Lich.SpritesheetKey.SPST_MAIN_KEY, "anm_meteor", Lich.AnimationSetKey.METEOR_ANIMATION_KEY, 5, 120, 120)
        ...
        new AnimationSetDefinition(Lich.SpritesheetKey.SPST_MAIN_KEY, "anm_bolt", Lich.AnimationSetKey.ICEBOLT_ANIMATION_KEY, 5, 60, 60)
        ...
        new AnimationSetDefinition(Lich.SpritesheetKey.SPST_MAIN_KEY, "anm_loveletter", Lich.AnimationSetKey.LOVELETTER_ANIMATION_KEY, 6, 32, 32)
        ...
        new AnimationSetDefinition(Lich.SpritesheetKey.SPST_MAIN_KEY, "anm_lovearrow", Lich.AnimationSetKey.LOVEARROW_ANIMATION_KEY, 6, 32, 32)

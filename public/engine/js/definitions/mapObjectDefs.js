...
(function (Lich) {
    ...
    Lich.MAP_OBJECT_DEFS = [
        ...
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_WOODEN_GOLD_CHEST_KEY, 2, 2, null, 0, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_WOODEN_CHEST_KEY, 2, 2, null, 0, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_ARMCHAIR_KEY, 2, 4, Lich.InventoryKey.INV_ARMCHAIR_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_BOOKS_KEY, 2, 2, Lich.InventoryKey.INV_BOOKS_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_BOOKSHELF_KEY, 2, 4, Lich.InventoryKey.INV_BOOKSHELF_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_CABINET_KEY, 2, 4, Lich.InventoryKey.INV_CABINET_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_CANDLE_KEY, 2, 2, Lich.InventoryKey.INV_CANDLE_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_PORTRAIT_VALENTIMON_KEY, 4, 4, Lich.InventoryKey.INV_PORTRAIT_VALENTIMON_KEY, 1, 0),
        ...
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_DEAD_FIREPLACE_KEY, 4, 2, Lich.InventoryKey.INV_FIREPLACE_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_DEAD_CHANDELIER_KEY, 4, 2, Lich.InventoryKey.INV_CHANDELIER_KEY, 1, 0),
        ...
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_SKELETON_ON_CHAIR_KEY, 2, 4, Lich.InventoryKey.INV_WOOD_CHAIR_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_IRON_FENCE_KEY, 2, 2, Lich.InventoryKey.INV_IRON_FENCE_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_WOOD_CHAIR_KEY, 2, 2, Lich.InventoryKey.INV_WOOD_CHAIR_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_WOOD_CHAIR2_KEY, 2, 2, Lich.InventoryKey.INV_WOOD_CHAIR_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_WOOD_TABLE_KEY, 2, 2, Lich.InventoryKey.INV_WOOD_TABLE_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_RED_FLASK_KEY, 2, 2, Lich.InventoryKey.INV_RED_FLASK_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_GOLD_COINS_KEY, 2, 2, Lich.InventoryKey.INV_GOLD_COINS_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_GOLD_COINS2_KEY, 2, 2, Lich.InventoryKey.INV_GOLD_COINS_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_SILVER_COINS_KEY, 2, 2, Lich.InventoryKey.INV_SILVER_COINS_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_GOLD_DISHES_KEY, 2, 2, Lich.InventoryKey.INV_GOLD_DISHES_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_GOLD_DISHES2_KEY, 2, 2, Lich.InventoryKey.INV_GOLD_DISHES2_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_GOLD_BOWL_KEY, 2, 2, Lich.InventoryKey.INV_GOLD_BOWL_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_TORCH_KEY, 2, 4, Lich.InventoryKey.INV_TORCH_KEY, 1, 0).setFrames(4),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_SNOWMAN_KEY, 2, 4, Lich.InventoryKey.INV_SNOWMAN_KEY, 1, 0),

...
(function (Lich) {
    Lich.MAP_OBJECT_DEFS = [
        ...
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_ANVIL_KEY, 2, 2, Lich.InventoryKey.INV_ANVIL_KEY, 1, 0),
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_SMELTER_KEY, 4, 4, Lich.InventoryKey.INV_SMELTER_KEY, 1, 0).setFrames(3),

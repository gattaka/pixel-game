...
(function (Lich) {
    ...
    Lich.MAP_OBJECT_DEFS = [
        ...
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_DEAD_FIREPLACE, 4, 2, Lich.InventoryKey.INV_FIREPLACE_KEY, 1, 0),
        ...
        new Lich.MapObjDefinition(Lich.MapObjectKey.MAP_SKELETON_ON_CHAIR, 2, 4, Lich.InventoryKey.INV_WOOD_CHAIR, 1, 0),

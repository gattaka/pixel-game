...
(function (Lich) {
    ...
    Lich.BACKGROUND_DEFS = [
        ...
        ["bgr_dirt_back" + tsf, Lich.BackgroundKey.DIRT_BACK_KEY],
        ["bgr_dirt_back_start" + tsf, Lich.BackgroundKey.DIRT_BACK_START_KEY],
        ["bgr_woodland1" + tsf, Lich.BackgroundKey.WOODLAND1_KEY],
        ["bgr_woodland2" + tsf, Lich.BackgroundKey.WOODLAND2_KEY],

...
(function (Lich) {
    var TilesMapGenerator = (function () {
        function TilesMapGenerator() {
            var self = this;
            var tilesMap = new Lich.TilesMap(TilesMapGenerator.MAP_WIDTH, TilesMapGenerator.MAP_HEIGHT);
            ...
            for (var y = 0; y < tilesMap.height; y++) {
                for (var x = 0; x < tilesMap.width; x++) {
                    if (y < TilesMapGenerator.MAP_GROUND_LEVEL) {
        ...
        // musí být sudé
        TilesMapGenerator.MAP_WIDTH = 800;
        TilesMapGenerator.MAP_HEIGHT = 500;
        TilesMapGenerator.MAP_GROUND_LEVEL = 60;

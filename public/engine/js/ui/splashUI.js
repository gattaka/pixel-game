...
(function (Lich) {
    ...
    var SplashScreenUI = (function (_super) {
        ...
        function SplashScreenUI() {
            ...
            self.print();
            var up = _this.createUpButton();
            _super.prototype.addChild.call(_this, up);
            up.x = self.fixedWidth + Lich.PartsUI.SELECT_BORDER;
            up.y = 0;
            var down = _this.createDownButton();
            _super.prototype.addChild.call(_this, down);
            down.x = self.fixedWidth + Lich.PartsUI.SELECT_BORDER;
            down.y = self.fixedHeight - Lich.Resources.PARTS_SIZE - Lich.PartsUI.BORDER;
            var save = _this.createSaveButton();
            _super.prototype.addChild.call(_this, save);
            save.x = 0 - Lich.PartsUI.SELECT_BORDER - Lich.Resources.PARTS_SIZE - Lich.PartsUI.BORDER;
            save.y = 0;
            var load = _this.createLoadButton();
            _super.prototype.addChild.call(_this, load);
            ...
            var newWorld = _this.createNewWorldButton();
        ...
        SplashScreenUI.prototype.createSaveButton = function () {
            var self = this;
            var btn = new Lich.Button(Lich.UISpriteKey.UI_SAVE_KEY, function () {
        ...
        SplashScreenUI.prototype.createLoadButton = function () {
            var self = this;
            var btn = new Lich.Button(Lich.UISpriteKey.UI_LOAD_KEY, function () {
        ...
        SplashScreenUI.prototype.createNewWorldButton = function () {
            var self = this;
            var btn = new Lich.Button(Lich.UISpriteKey.UI_NEW_WORLD_KEY, function () {

namespace Lich {
    ...
    export let MAP_OBJECT_DEFS = [
        ...
        new MapObjDefinition(MapObjectKey.MAP_WOODEN_GOLD_CHEST_KEY, 2, 2, null, 0, 0),
        new MapObjDefinition(MapObjectKey.MAP_WOODEN_CHEST_KEY, 2, 2, null, 0, 0),
        new MapObjDefinition(MapObjectKey.MAP_ARMCHAIR_KEY, 2, 4, InventoryKey.INV_ARMCHAIR_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_BOOKS_KEY, 2, 2, InventoryKey.INV_BOOKS_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_BOOKSHELF_KEY, 2, 4, InventoryKey.INV_BOOKSHELF_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_CABINET_KEY, 2, 4, InventoryKey.INV_CABINET_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_CANDLE_KEY, 2, 2, InventoryKey.INV_CANDLE_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_PORTRAIT_VALENTIMON_KEY, 4, 4, InventoryKey.INV_PORTRAIT_VALENTIMON_KEY, 1, 0),
        ...
        new MapObjDefinition(MapObjectKey.MAP_DEAD_FIREPLACE_KEY, 4, 2, InventoryKey.INV_FIREPLACE_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_DEAD_CHANDELIER_KEY, 4, 2, InventoryKey.INV_CHANDELIER_KEY, 1, 0),
        ...
        new MapObjDefinition(MapObjectKey.MAP_SKELETON_ON_CHAIR_KEY, 2, 4, InventoryKey.INV_WOOD_CHAIR_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_IRON_FENCE_KEY, 2, 2, InventoryKey.INV_IRON_FENCE_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_WOOD_CHAIR_KEY, 2, 2, InventoryKey.INV_WOOD_CHAIR_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_WOOD_CHAIR2_KEY, 2, 2, InventoryKey.INV_WOOD_CHAIR_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_WOOD_TABLE_KEY, 2, 2, InventoryKey.INV_WOOD_TABLE_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_RED_FLASK_KEY, 2, 2, InventoryKey.INV_RED_FLASK_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_COINS_KEY, 2, 2, InventoryKey.INV_GOLD_COINS_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_COINS2_KEY, 2, 2, InventoryKey.INV_GOLD_COINS_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_SILVER_COINS_KEY, 2, 2, InventoryKey.INV_SILVER_COINS_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_DISHES_KEY, 2, 2, InventoryKey.INV_GOLD_DISHES_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_DISHES2_KEY, 2, 2, InventoryKey.INV_GOLD_DISHES2_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_BOWL_KEY, 2, 2, InventoryKey.INV_GOLD_BOWL_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_TORCH_KEY, 2, 4, InventoryKey.INV_TORCH_KEY, 1, 0).setFrames(4),
        new MapObjDefinition(MapObjectKey.MAP_SNOWMAN_KEY, 2, 4, InventoryKey.INV_SNOWMAN_KEY, 1, 0),

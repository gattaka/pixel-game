namespace Lich {
    ...
    export let MAP_OBJECT_DEFS = [
        ...
        new MapObjDefinition(MapObjectKey.MAP_SKELETON_ON_CHAIR_KEY, 2, 4, InventoryKey.INV_WOOD_CHAIR, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_IRON_FENCE_KEY, 2, 2, InventoryKey.INV_IRON_FENCE_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_WOOD_CHAIR_KEY, 2, 2, InventoryKey.INV_WOOD_CHAIR, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_WOOD_CHAIR2_KEY, 2, 2, InventoryKey.INV_WOOD_CHAIR, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_WOOD_TABLE_KEY, 2, 2, InventoryKey.INV_WOOD_TABLE, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_RED_FLASK_KEY, 2, 2, InventoryKey.INV_RED_FLASK_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_COINS_KEY, 2, 2, InventoryKey.INV_GOLD_COINS, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_COINS2_KEY, 2, 2, InventoryKey.INV_GOLD_COINS, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_SILVER_COINS_KEY, 2, 2, InventoryKey.INV_SILVER_COINS, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_DISHES_KEY, 2, 2, InventoryKey.INV_GOLD_DISHES, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_DISHES2_KEY, 2, 2, InventoryKey.INV_GOLD_DISHES2, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_BOWL_KEY, 2, 2, InventoryKey.INV_GOLD_BOWL, 1, 0),

namespace Lich {
    ...
    export let MAP_OBJECT_DEFS = [
        ...
        new MapObjDefinition(MapObjectKey.MAP_DEAD_FIREPLACE, 4, 2, InventoryKey.INV_FIREPLACE_KEY, 1, 0),
        ...
        new MapObjDefinition(MapObjectKey.MAP_SKELETON_ON_CHAIR, 2, 4, InventoryKey.INV_WOOD_CHAIR, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_IRON_FENCE_KEY, 2, 2, InventoryKey.INV_IRON_FENCE_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_WOOD_CHAIR, 2, 2, InventoryKey.INV_WOOD_CHAIR, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_WOOD_CHAIR2, 2, 2, InventoryKey.INV_WOOD_CHAIR, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_WOOD_TABLE, 2, 2, InventoryKey.INV_WOOD_TABLE, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_RED_FLASK_KEY, 2, 2, InventoryKey.INV_RED_FLASK_KEY, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_COINS, 2, 2, InventoryKey.INV_GOLD_COINS, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_COINS2, 2, 2, InventoryKey.INV_GOLD_COINS, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_SILVER_COINS, 2, 2, InventoryKey.INV_SILVER_COINS, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_DISHES, 2, 2, InventoryKey.INV_GOLD_DISHES, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_DISHES2, 2, 2, InventoryKey.INV_GOLD_DISHES2, 1, 0),
        new MapObjDefinition(MapObjectKey.MAP_GOLD_BOWL, 2, 2, InventoryKey.INV_GOLD_BOWL, 1, 0),

namespace Lich {
    ...
    export let ANIMATION_DEFS: Array<AnimationDefinition> = [
        ...
        ["hellhound", AnimationSetKey.HELLHOUND_ANIMATION_KEY],
        ["valentimon", AnimationSetKey.VALENTIMON_ANIMATION_KEY],
        ["cupid", AnimationSetKey.CUPID_ANIMATION_KEY],
        // gfx animations
        ["meteor_animation", AnimationSetKey.METEOR_ANIMATION_KEY],
        ["blast_animation", AnimationSetKey.FIREBALL_ANIMATION_KEY],
        ["bolt_animation", AnimationSetKey.BOLT_ANIMATION_KEY],
        ["loveletter_animation", AnimationSetKey.LOVELETTER_ANIMATION_KEY],
        ["lovearrow_animation", AnimationSetKey.LOVEARROW_ANIMATION_KEY]
    ]
}
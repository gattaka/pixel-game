namespace Lich {
    ...
    export let ANIMATION_DEFS: Array<AnimationSetDefinition> = [
        ...
        new AnimationSetDefinition("anm_alien", AnimationSetKey.ALIEN_ANIMATION_KEY, 36, 151, 100)
            .add(AnimationKey.ANM_ALIEN_WALKL_KEY, 0, 11, AnimationKey.ANM_ALIEN_WALKL_KEY, 0.2)
            .add(AnimationKey.ANM_ALIEN_WALKR_KEY, 12, 23, AnimationKey.ANM_ALIEN_WALKR_KEY, 0.2)
            .add(AnimationKey.ANM_ALIEN_ATTACKL_KEY, 24, 28, AnimationKey.ANM_ALIEN_ATTACKL_KEY, 0.2)
            .add(AnimationKey.ANM_ALIEN_ATTACKR_KEY, 30, 34, AnimationKey.ANM_ALIEN_ATTACKR_KEY, 0.2)
            .add(AnimationKey.ANM_ALIEN_DIE_KEY, 35, 35, AnimationKey.ANM_ALIEN_DIE_KEY, 0.2),
        // gfx animations

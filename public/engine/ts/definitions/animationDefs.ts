namespace Lich {
    ...
    export let ANIMATION_DEFS: Array<AnimationDefinition> = [
        // characters
        new AnimationDefinition(SpritesheetKey.SPST_OBJECTS_KEY, "lich_animation", AnimationSetKey.LICH_ANIMATION_KEY, 56, 80)
        ...
        new AnimationDefinition(SpritesheetKey.SPST_OBJECTS_KEY, "bunny", AnimationSetKey.BUNNY_ANIMATION_KEY, 32, 32)
        ...
        new AnimationDefinition(SpritesheetKey.SPST_OBJECTS_KEY, "chicken", AnimationSetKey.CHICKEN_ANIMATION_KEY, 26, 26)
        ...
        new AnimationDefinition(SpritesheetKey.SPST_OBJECTS_KEY, "corpse_animation", AnimationSetKey.CORPSE_ANIMATION_KEY, 56, 80)
            .add(AnimationKey.ANM_HERO_IDLE_KEY, 0, 0, AnimationKey.ANM_HERO_BREATH_KEY, 0.005)
            .add(AnimationKey.ANM_HERO_BREATH_KEY, 1, 1, AnimationKey.ANM_HERO_IDLE_KEY, 0.04)
            .add(AnimationKey.ANM_HERO_WALKR_KEY, 2, 9, AnimationKey.ANM_HERO_WALKR_KEY, 0.3)
            .add(AnimationKey.ANM_HERO_WALKL_KEY, 10, 17, AnimationKey.ANM_HERO_WALKL_KEY, 0.3)
            ...
            .add(AnimationKey.ANM_HERO_DIE_KEY, 28, 28, AnimationKey.ANM_HERO_DEAD_KEY, 0.2)
            .add(AnimationKey.ANM_HERO_DEAD_KEY, 29, 29, AnimationKey.ANM_HERO_DEAD_KEY, 0.2),
        new AnimationDefinition(SpritesheetKey.SPST_OBJECTS_KEY, "chicken_boss", AnimationSetKey.CHICKEN_BOSS_ANIMATION_KEY, 184, 304)
        ...
        new AnimationDefinition(SpritesheetKey.SPST_OBJECTS_KEY, "hellhound", AnimationSetKey.HELLHOUND_ANIMATION_KEY, 128, 86)
        ...
        new AnimationDefinition(SpritesheetKey.SPST_OBJECTS_KEY, "cupid", AnimationSetKey.CUPID_ANIMATION_KEY, 256, 320)
        ...
        new AnimationDefinition(SpritesheetKey.SPST_OBJECTS_KEY, "valentimon", AnimationSetKey.VALENTIMON_ANIMATION_KEY, 64, 64)
        ...
        // gfx animations
        new AnimationDefinition(SpritesheetKey.SPST_OBJECTS_KEY, "blast_animation", AnimationSetKey.FIREBALL_ANIMATION_KEY, 60, 60)
        ...
        new AnimationDefinition(SpritesheetKey.SPST_OBJECTS_KEY, "meteor_animation", AnimationSetKey.METEOR_ANIMATION_KEY, 120, 120)
        ...
        new AnimationDefinition(SpritesheetKey.SPST_OBJECTS_KEY, "bolt_animation", AnimationSetKey.ICEBOLT_ANIMATION_KEY, 60, 60)
        ...
        new AnimationDefinition(SpritesheetKey.SPST_OBJECTS_KEY, "loveletter_animation", AnimationSetKey.LOVELETTER_ANIMATION_KEY, 32, 32)
        ...
        new AnimationDefinition(SpritesheetKey.SPST_OBJECTS_KEY, "lovearrow_animation", AnimationSetKey.LOVEARROW_ANIMATION_KEY, 32, 32)

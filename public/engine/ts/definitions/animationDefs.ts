namespace Lich {
    ...
    export let ANIMATION_DEFS: Array<AnimationSetDefinition> = [
        // characters
        new AnimationSetDefinition(SpritesheetKey.SPST_MAIN_KEY, "lich_animation", AnimationSetKey.LICH_ANIMATION_KEY, 40, 56, 80)
        ...
        new AnimationSetDefinition(SpritesheetKey.SPST_MAIN_KEY, "bunny", AnimationSetKey.BUNNY_ANIMATION_KEY, 13, 32, 32)
        ...
        new AnimationSetDefinition(SpritesheetKey.SPST_MAIN_KEY, "chicken", AnimationSetKey.CHICKEN_ANIMATION_KEY, 15, 26, 26)
        ...
        new AnimationSetDefinition(SpritesheetKey.SPST_MAIN_KEY, "corpse_animation", AnimationSetKey.CORPSE_ANIMATION_KEY, 30, 56, 80)
        ...
        new AnimationSetDefinition(SpritesheetKey.SPST_MAIN_KEY, "chicken_boss", AnimationSetKey.CHICKEN_BOSS_ANIMATION_KEY, 2, 184, 304)
        ...
        new AnimationSetDefinition(SpritesheetKey.SPST_MAIN_KEY, "hellhound", AnimationSetKey.HELLHOUND_ANIMATION_KEY, 25, 128, 86)
        ...
        new AnimationSetDefinition(SpritesheetKey.SPST_MAIN_KEY, "cupid", AnimationSetKey.CUPID_ANIMATION_KEY, 6, 256, 320)
        ...
        new AnimationSetDefinition(SpritesheetKey.SPST_MAIN_KEY, "valentimon", AnimationSetKey.VALENTIMON_ANIMATION_KEY, 9, 64, 64)
        ...
        // gfx animations
        new AnimationSetDefinition(SpritesheetKey.SPST_MAIN_KEY, "blast_animation", AnimationSetKey.FIREBALL_ANIMATION_KEY, 5, 60, 60)
        ...
        new AnimationSetDefinition(SpritesheetKey.SPST_MAIN_KEY, "meteor_animation", AnimationSetKey.METEOR_ANIMATION_KEY, 5, 120, 120)
        ...
        new AnimationSetDefinition(SpritesheetKey.SPST_MAIN_KEY, "bolt_animation", AnimationSetKey.ICEBOLT_ANIMATION_KEY, 5, 60, 60)
        ...
        new AnimationSetDefinition(SpritesheetKey.SPST_MAIN_KEY, "loveletter_animation", AnimationSetKey.LOVELETTER_ANIMATION_KEY, 6, 32, 32)
        ...
        new AnimationSetDefinition(SpritesheetKey.SPST_MAIN_KEY, "lovearrow_animation", AnimationSetKey.LOVEARROW_ANIMATION_KEY, 6, 32, 32)

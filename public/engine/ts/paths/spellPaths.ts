namespace Lich {
    export let SPELL_PATHS: Array<[string, SpellKey]> = [
        ["dig_spell", SpellKey.SPELL_DIG_KEY],
        ["dig_bgr_spell", SpellKey.SPELL_DIG_BGR_KEY],
        ["fireball_spell", SpellKey.SPELL_FIREBALL_KEY],
        ...
        ["use_spell", SpellKey.SPELL_USE_ITEM_KEY],
        ["place_spell", SpellKey.SPELL_REVEAL_FOG_KEY]    
    ]
}
namespace Lich {
    export let SURFACE_BGR_DEFS = [
        new MapSurfaceBgrDefinition(SurfaceBgrKey.SRFC_BGR_BRICK_KEY, InventoryKey.INV_BRICK_KEY, 1),
        new MapSurfaceBgrDefinition(SurfaceBgrKey.SRFC_BGR_ROCK_BRICK_KEY, InventoryKey.INV_ROCK_BRICK_KEY, 1),

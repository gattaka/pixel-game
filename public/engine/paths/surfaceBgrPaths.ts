namespace Lich {
    export let SURFACE_BGR_PATHS: Array<[string, SurfaceBgrKey]> = [
        ["images/surfaces/woodwall_bgr.png", SurfaceBgrKey.SRFC_BGR_WOODWALL_KEY],
        ["images/surfaces/brick_bgr.png", SurfaceBgrKey.SRFC_BGR_BRICK_KEY],

...
(function (Lich) {
    var Background = (function () {
        function Background(game) {
            ...
            self.far_mountain = resources.getBitmap(Lich.BackgroundKey.FAR_MOUNTAIN_KEY);
            self.far_mountain_sec = resources.getBitmap(Lich.BackgroundKey.FAR_MOUNTAIN_KEY);
            self.mountain = resources.getBitmap(Lich.BackgroundKey.MOUNTAIN_KEY);
            self.mountain_sec = resources.getBitmap(Lich.BackgroundKey.MOUNTAIN_KEY);
            self.hill = resources.getBitmap(Lich.BackgroundKey.HILL_KEY);
            self.hill_sec = resources.getBitmap(Lich.BackgroundKey.HILL_KEY);
            self.far_hill = resources.getBitmap(Lich.BackgroundKey.FAR_HILL_KEY);
            self.far_hill_sec = resources.getBitmap(Lich.BackgroundKey.FAR_HILL_KEY);
            for (var i = 1; i <= Lich.Resources.CLOUDS_NUMBER; i++) {
                self.clouds.push(resources.getBitmap(Lich.BackgroundKey.CLOUD_KEY + i));
            }
            self.sky = new createjs.Shape();
            game.stage.addChild(self.sky);
            self.sky.x = 0;
            self.sky.y = 0;
            self.sky.graphics.beginBitmapFill(resources.getImage(Lich.BackgroundKey.SKY_KEY), 'repeat').drawRect(0, 0, game.canvas.width, 250);
            ...
            self.dirt_back_startImg = resources.getImage(Lich.BackgroundKey.DIRT_BACK_START_KEY);
            ...
            self.dirt_backImg = resources.getImage(Lich.BackgroundKey.DIRTBACK_KEY);
